...
class TwoStateMachine(mdp.MDP):
    ...
    def __init__(self):
        ...
        self._rewards = {
            ...
            # Encodes the reward (0) of arc prone -> upright by action stand.
            (TwoStateMachine.States.prone,
             TwoStateMachine.Actions.stand,
             TwoStateMachine.States.upright): 0,  
            # Encodes the reward (20) of arc upright -> upright by action wlak.
            (TwoStateMachine.States.upright,
             TwoStateMachine.Actions.walk,
        ...
        self._probs = {
            ...
            # Encodes the prob (0.1) of arc upright -> prone by action walk.
            (TwoStateMachine.States.upright,
             TwoStateMachine.Actions.walk,
             TwoStateMachine.States.prone): 0.1,
            # Encodes the prob (1.0) of arc prone -> upright by action stand.
            (TwoStateMachine.States.prone,
             TwoStateMachine.Actions.stand,
             TwoStateMachine.States.upright): 1.0,  
            # Encodes the prob (0.9) of arc upright -> upright by action wlak.
            (TwoStateMachine.States.upright,
             TwoStateMachine.Actions.walk,
